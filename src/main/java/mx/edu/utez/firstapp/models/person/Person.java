...
public class Person {
    ...
    public Person(Long id, String name, String surname, String lastname, LocalDate birthDate, String curp, Boolean status) {
        this.id = id;
        this.name = name;
        this.surname = surname;
        this.lastname = lastname;
    ...
    public Person(Long id, String name, String surname, String lastname, LocalDate birthDate, String curp, Boolean status, User user) {
        this.id = id;
        this.name = name;
        this.surname = surname;
        this.lastname = lastname;
